...
<section class="container-fluid whybg">
    ...
    <section class="container-fluid toursbg">
        ...
        <div class="container ghostly">
            <div class="container col-sm-2">
                <img class="tourimg" src=http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/prisontour.jpg alt="Prison Tour" height=200>
            </div>
        ...
        <div class="container evening">
            <div class="container col-sm-2 evening-image">
                <img class="tourimg" src=http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/eveningfood.jpg alt="Prison Tour" height=200>
            </div>
        ...
        <div class="container market">
            <div class="container col-sm-2">
                <img class="tourimg" src=http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/markets.jpg alt="Prison Tour" height=200>
            </div>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="container exploreimgs text-center">
                <div class="col-md-6 ferris">
                    <img class="img-fluid exploreimg1" src=http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/explore1.jpg alt="Prison Tour" height="500">
                </div>
                <div class="col-md-6 graffiti">
                    <img class="img-fluid explorimg2" src=http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/explore2.jpg alt="Prison Tour" height="500">
                </div>
            </div>
        </div><!-- container-->
    </div>
    ...
    <div class="container-fluid instasec">
        <div class="container instatop">
            <div class="col-md-2">
                <img src="http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/instalogo.png" alt="Instagram Logo" height="100">
            </div>
            <div class="container instatext">
                <a class="instalink" href="http://instagram.com">@FLIPSIDE</a>
                <p class="instasub">Find us on Instagram and get lost in the many photos available of the tours.</p>
            </div>
            <div class="row instafeed">
                <div class="column">
                    <img src="http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/instaimg1.jpg" alt="Ferris Wheel" style="width:100%">
                </div>
                <div class="column">
                    <img src="http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/instaimg2.jpg" alt="Locals watching performers" style="width:100%">
                </div>
                <div class="column">
                    <img src="http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/instaimg3.jpg" alt="Children playing on the playground" style="width:100%">
                </div>
                <div class="column">
                    <img src="http://206.189.45.97/~mesh21/sub/wp-content/uploads/2021/06/instaimg4.jpg" alt="Visitors outside of Fremantle Prison" style="width:100%">
                </div>
            </div>
        </div>
    </div>
